                ...
                <Swiper className={"bigSlider"}
                    ...
                    {slides.map((item, index) =>
                        <SwiperSlide key={"bigSlide-" + item.id} tag={"li"} >
                            ...
                            {item.texts && <div className={"bigSlider__texts"}>
